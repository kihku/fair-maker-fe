      ...
      <div className="mt-24 w-full lg:w-3/5 ">
        <div className="text-center">
          ...
          <Typography
            variant="paragraph"
            color="blue-gray"
            className="text-lg font-normal dark:text-slate-400"
          >
        ...
        <form className="mx-auto mb-2 mt-8 w-80 max-w-screen-lg lg:w-1/2">
          <div className="mb-1 flex flex-col gap-6">
            <Typography
              variant="small"
              color="blue-gray"
              className="-mb-3 font-medium dark:text-white"
            >
              Your email
            </Typography>
            <Input
              ...
              className=" !border-t-blue-gray-200 focus:!border-t-gray-900 dark:text-white dark:focus:!border-white"
              labelProps={{
